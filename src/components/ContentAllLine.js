...
export default function ContentAllLine() {
    return (
          ...
          <div className="card">
            <div className="card-header border-0">
              <div className="d-flex justify-content-between">
                ...
                <a href="./ContentAllBar">Change to bargraph</a>
              </div>
            </div>
            <div className="card-body">
              ...
              <div className="position-relative mb-4"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
                <canvas id="Allsensor-Linechart" height={250} width={592} className="chartjs-render-monitor" style={{display: 'block', height: 200, width: 474}} />
              </div>
